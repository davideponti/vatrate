      ...
      <header style={{padding: '20px 32px', background: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(229,231,235,0.5)', position: 'sticky', top: 0, zIndex: 50}}>
        <div style={{maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
          ...
          <nav style={{display: 'flex', gap: 8, alignItems: 'center'}}>
            {isLoggedIn ? (
              <>
                <Link href="/dashboard" style={{padding: '8px 16px', color: '#4b5563', textDecoration: 'none', fontSize: 14, fontWeight: 500, borderRadius: 8}}>Dashboard</Link>
                <Link href="/dashboard/logs" style={{padding: '8px 16px', color: '#4b5563', textDecoration: 'none', fontSize: 14, fontWeight: 500, borderRadius: 8}}>Logs</Link>
                <Link href="/dashboard/settings" style={{padding: '8px 16px', color: '#4b5563', textDecoration: 'none', fontSize: 14, fontWeight: 500, borderRadius: 8}}>Settings</Link>
                ...
                <button onClick={handleLogout} style={{padding: '8px 16px', background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 600}}>Logout</button>
              </>
            ) : (
              <>
                <Link href="/docs" style={{padding: '8px 16px', color: '#4b5563', textDecoration: 'none', fontSize: 14, fontWeight: 500, borderRadius: 8}}>Docs</Link>
            ...
            <a href="https://github.com/davideponti/vatrate" target="_blank" style={{padding: '8px 16px', background: '#f3f4f6', color: '#1e293b', borderRadius: 8, textDecoration: 'none', fontSize: 14, fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 4}}>
