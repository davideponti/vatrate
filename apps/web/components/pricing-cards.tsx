...
const plans = [
  ...
  },
  {
    ...
    features: ['1,000 req/month', 'Auto-updated rates', 'Email support'],
    cta: 'Subscribe',
    popular: true,
  },
  {
    ...
    features: ['10,000 req/month', 'Product classification', 'Priority support'],
    cta: 'Subscribe',
  },
  {
    id: 'enterprise',
    ...
    features: ['100,000 req/month', 'Alerts & webhooks', 'SLA 99.9%'],
    cta: 'Contact Us',
  },
];
