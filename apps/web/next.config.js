        ...
        headers: [
          // Content Security Policy - prevents XSS and data injection
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https: https://*.githubusercontent.com https://*.googleusercontent.com",
              "font-src 'self' data:",
              "connect-src 'self' https://api.vatrate.eu https://vatrate.eu https://*.supabase.co https://github.com https://accounts.google.com",
